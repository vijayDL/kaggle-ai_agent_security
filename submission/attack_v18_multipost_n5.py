# v18-multipost-n5 (2026-08-11, see STATE.md): PUBLIC-chasing bet, midpoint dose-response
# point between v18-multipost-n4 (79.740) and v18-multipost-n6 (90.385) -- N=5 instead of
# N=4/N=6/N=7/N=8. Otherwise byte-identical to attack_v17_edge.py (88.920, current best
...
SLOW_MULTIPOST_N = 5          # 2026-08-11 v18 PUBLIC BET: midpoint between the failed N=4
                              # (79.740, -10.3%) and winning N=6 (90.385, +1.6%). Tests
                              # whether the N=4/N=6 gap traces a smooth curve (N=5 lands
                              # between them) or whether N=6 was a lucky single run (N=5
                              # lands anywhere, uncorrelated). Submitted alongside unchanged
                              # reruns of N=4, N=6, and v17-edge to separate curve shape from
                              # noise -- see STATE.md. gpt_oss row only; see
                              # attack_v18_multipost_n4.py for the gemma-brace-bug
                              # non-interaction note.
