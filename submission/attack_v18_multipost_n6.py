# v18-multipost-n6 (2026-08-09, see STATE.md): PUBLIC-chasing bet, dose-response sibling of
# v18-multipost-n4 (SLOW_MULTIPOST_N 1->6). Otherwise byte-identical to attack_v17_edge.py
...
SLOW_MULTIPOST_N = 6          # 2026-08-09 v18 PUBLIC BET: dose-response sibling of
                              # attack_v18_multipost_n4.py -- same lever, N=6 instead of N=4,
                              # to see whether the amortization gain keeps scaling past N=4 on
                              # LIVE Kaggle T4 hardware (the old local Pareto sweep on Blackwell
                              # found N=4->8 worth only +2.8% combined and picked N=4 for cell-
                              # diversity reasons that do not apply to a pure public-chasing
                              # slot). gpt_oss row only; see attack_v18_multipost_n4.py for the
                              # gemma-brace-bug non-interaction note.
